...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="absolute z-[1000] top-[45%] right-6 flex flex-col gap-5">
      ...
      >
        ...
        <div className="pt-2 rounded-3xl relative w-screen h-screen">
          <div className="flex items-center justify-center object-fill -mt-2 h-[100vh] w-[100vw] bg-gradient-to-b from-gray-900 to-blue-950">
            {" "}
            <h2 className="text-6xl bg-gradient-to-b from-slate-300 to-slate-600 bg-clip-text text-transparent font-extrabold scale-[300%]">
              Video 2
            </h2>{" "}
          </div>
        </div>
